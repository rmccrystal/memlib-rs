use crate::math::{Vector3, Angles2, radians_to_deg};
...
pub fn calculate_aimbot(source_position: Vector3, target_position: Vector3, _view_angles: Angles2, _smooth: f32) -> Angles2 {
